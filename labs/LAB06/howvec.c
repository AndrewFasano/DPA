...
static InsnClassExecCount x86_64_insn_classes[] = {
#if 0
    { "Call",                "call",   0x000000ff, 0xe8000000, COUNT_CLASS},
    { "Call",                "call",   0x000000ff, 0x9a000000, COUNT_CLASS},
    { "Jump",                "jmp",    0x000000ff, 0xe9000000, COUNT_CLASS},
#endif
    { "Jump",                "jmp",    0x000000ff, 0x000000eb, COUNT_CLASS},
    { "Unclassified",        "unclas", 0x00000000, 0x00000000, COUNT_INDIVIDUAL},
};
...
static ClassSelector class_tables[] = {
    ...
    { "x86_64", x86_64_insn_classes, ARRAY_SIZE(x86_64_insn_classes) },
