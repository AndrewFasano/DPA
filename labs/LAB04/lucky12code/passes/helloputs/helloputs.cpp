...
bool HelloPuts::doInitialization(Module &M) {
...
bool HelloPuts::runOnFunction(Function &F) {
...
char HelloPuts::ID = 0;
static RegisterPass<HelloPuts>
Y("helloputs", "Hello Puts Pass");
